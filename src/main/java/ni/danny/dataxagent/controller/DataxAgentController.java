...
public class DataxAgentController {
    ...
    @GetMapping("/testPy")
    public Object testPy(){
        PythonInterpreter interpreter = new PythonInterpreter();
        interpreter.execfile("/Users/danny_ni/Workspace/dev-tools/datax/bin/datax.py");
        return "SUCCESS";
    }
    ...
    @GetMapping("/test")
    public ResponseDTO test(@RequestParam String jobJsonPath) throws Throwable {
